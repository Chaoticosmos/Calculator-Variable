...
int main() {
	...
	int num;
	char fourstring;
	double pownum1, pownum2, sqrtnum, plusnum1, plusnum2, minusnum1, minusnum2, multyplynum1, multyplynum2, divisionnum1, divisionnum2, numa, numb, numc, numx, numxp = 0, numap = 0, numbp = 0, equationsnum1 = 0, equationsnum2 = 0, equationsnum3 = 0, equationsnum4 = 0, equationsnum5 = 0, equationsnum6 = 0, equationsnumx = 0, equationsnumy = 0, equationsprog1 = 0, equationsprog2 = 0, equationsprog3 = 0, equationsprog4 = 0;
